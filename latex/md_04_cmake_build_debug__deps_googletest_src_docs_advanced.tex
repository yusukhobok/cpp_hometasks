\hypertarget{md_04_cmake_build_debug__deps_googletest_src_docs_advanced_autotoc_md22}{}\doxysection{Introduction}\label{md_04_cmake_build_debug__deps_googletest_src_docs_advanced_autotoc_md22}
Now that you have read the \mbox{\hyperlink{md_04_cmake_build_debug__deps_googletest_src_docs_primer}{googletest Primer}} and learned how to write tests using googletest, it\textquotesingle{}s time to learn some new tricks. This document will show you more assertions as well as how to construct complex failure messages, propagate fatal failures, reuse and speed up your test fixtures, and use various flags with your tests.\hypertarget{md_04_cmake_build_debug__deps_googletest_src_docs_advanced_autotoc_md23}{}\doxysection{More Assertions}\label{md_04_cmake_build_debug__deps_googletest_src_docs_advanced_autotoc_md23}
This section covers some less frequently used, but still significant, assertions.\hypertarget{md_04_cmake_build_debug__deps_googletest_src_docs_advanced_autotoc_md24}{}\doxysubsection{Explicit Success and Failure}\label{md_04_cmake_build_debug__deps_googletest_src_docs_advanced_autotoc_md24}
See \href{reference/assertions.md\#success-failure}{\texttt{ Explicit Success and Failure}} in the Assertions Reference.\hypertarget{md_04_cmake_build_debug__deps_googletest_src_docs_advanced_autotoc_md25}{}\doxysubsection{Exception Assertions}\label{md_04_cmake_build_debug__deps_googletest_src_docs_advanced_autotoc_md25}
See \href{reference/assertions.md\#exceptions}{\texttt{ Exception Assertions}} in the Assertions Reference.\hypertarget{md_04_cmake_build_debug__deps_googletest_src_docs_advanced_autotoc_md26}{}\doxysubsection{Predicate Assertions for Better Error Messages}\label{md_04_cmake_build_debug__deps_googletest_src_docs_advanced_autotoc_md26}
...
googletest gives you three different options to solve this problem\+:\hypertarget{md_04_cmake_build_debug__deps_googletest_src_docs_advanced_autotoc_md27}{}\doxysubsubsection{Using an Existing Boolean Function}\label{md_04_cmake_build_debug__deps_googletest_src_docs_advanced_autotoc_md27}
If you already have a function or functor that returns {\ttfamily bool} (or a type that can be implicitly converted to {\ttfamily bool}), you can use it in a {\itshape predicate assertion} to get the function arguments printed for free. See \href{reference/assertions.md\#EXPECT_PRED}{\texttt{ {\ttfamily EXPECT\+\_\+\+PRED$\ast$}}} in the Assertions Reference for details.\hypertarget{md_04_cmake_build_debug__deps_googletest_src_docs_advanced_autotoc_md28}{}\doxysubsubsection{Using a Function That Returns an Assertion\+Result}\label{md_04_cmake_build_debug__deps_googletest_src_docs_advanced_autotoc_md28}
...
\end{DoxyCode}
\hypertarget{md_04_cmake_build_debug__deps_googletest_src_docs_advanced_autotoc_md29}{}\doxysubsubsection{Using a Predicate-\/\+Formatter}\label{md_04_cmake_build_debug__deps_googletest_src_docs_advanced_autotoc_md29}
If you find the default message generated by \href{reference/assertions.md\#EXPECT_PRED}{\texttt{ {\ttfamily EXPECT\+\_\+\+PRED$\ast$}}} and \href{reference/assertions.md\#EXPECT_TRUE}{\texttt{ {\ttfamily EXPECT\+\_\+\+TRUE}}} unsatisfactory, or some arguments to your predicate do not support streaming to {\ttfamily ostream}, you can instead use {\itshape predicate-\/formatter assertions} to {\itshape fully} customize how the message is formatted. See \href{reference/assertions.md\#EXPECT_PRED_FORMAT}{\texttt{ {\ttfamily EXPECT\+\_\+\+PRED\+\_\+\+FORMAT$\ast$}}} in the Assertions Reference for details.\hypertarget{md_04_cmake_build_debug__deps_googletest_src_docs_advanced_autotoc_md30}{}\doxysubsection{Floating-\/\+Point Comparison}\label{md_04_cmake_build_debug__deps_googletest_src_docs_advanced_autotoc_md30}
See \href{reference/assertions.md\#floating-point}{\texttt{ Floating-\/\+Point Comparison}} in the Assertions Reference.\hypertarget{md_04_cmake_build_debug__deps_googletest_src_docs_advanced_autotoc_md31}{}\doxysubsubsection{Floating-\/\+Point Predicate-\/\+Format Functions}\label{md_04_cmake_build_debug__deps_googletest_src_docs_advanced_autotoc_md31}
...
The above code verifies that {\ttfamily val1} is less than, or approximately equal to, {\ttfamily val2}.\hypertarget{md_04_cmake_build_debug__deps_googletest_src_docs_advanced_autotoc_md32}{}\doxysubsection{Asserting Using g\+Mock Matchers}\label{md_04_cmake_build_debug__deps_googletest_src_docs_advanced_autotoc_md32}
See \href{reference/assertions.md\#EXPECT_THAT}{\texttt{ {\ttfamily EXPECT\+\_\+\+THAT}}} in the Assertions Reference.\hypertarget{md_04_cmake_build_debug__deps_googletest_src_docs_advanced_autotoc_md33}{}\doxysubsection{More String Assertions}\label{md_04_cmake_build_debug__deps_googletest_src_docs_advanced_autotoc_md33}
...
\end{DoxyCode}
\hypertarget{md_04_cmake_build_debug__deps_googletest_src_docs_advanced_autotoc_md34}{}\doxysubsection{Windows HRESULT assertions}\label{md_04_cmake_build_debug__deps_googletest_src_docs_advanced_autotoc_md34}
See \href{reference/assertions.md\#HRESULT}{\texttt{ Windows HRESULT Assertions}} in the Assertions Reference.\hypertarget{md_04_cmake_build_debug__deps_googletest_src_docs_advanced_autotoc_md35}{}\doxysubsection{Type Assertions}\label{md_04_cmake_build_debug__deps_googletest_src_docs_advanced_autotoc_md35}
...
to cause a compiler error.\hypertarget{md_04_cmake_build_debug__deps_googletest_src_docs_advanced_autotoc_md36}{}\doxysubsection{Assertion Placement}\label{md_04_cmake_build_debug__deps_googletest_src_docs_advanced_autotoc_md36}
...
\{\+: .callout .warning\} WARNING\+: A fatal assertion in a helper function (private void-\/returning method) called from a constructor or destructor does not terminate the current test, as your intuition might suggest\+: it merely returns from the constructor or destructor early, possibly leaving your object in a partially-\/constructed or partially-\/destructed state! You almost certainly want to {\ttfamily abort} or use {\ttfamily Set\+Up}/{\ttfamily Tear\+Down} instead.\hypertarget{md_04_cmake_build_debug__deps_googletest_src_docs_advanced_autotoc_md37}{}\doxysection{Skipping test execution}\label{md_04_cmake_build_debug__deps_googletest_src_docs_advanced_autotoc_md37}
...
As with assertion macros, you can stream a custom message into {\ttfamily GTEST\+\_\+\+SKIP()}.\hypertarget{md_04_cmake_build_debug__deps_googletest_src_docs_advanced_autotoc_md38}{}\doxysection{Teaching googletest How to Print Your Values}\label{md_04_cmake_build_debug__deps_googletest_src_docs_advanced_autotoc_md38}
...
\end{DoxyCode}
\hypertarget{md_04_cmake_build_debug__deps_googletest_src_docs_advanced_autotoc_md39}{}\doxysection{Death Tests}\label{md_04_cmake_build_debug__deps_googletest_src_docs_advanced_autotoc_md39}
...
If you want to test {\ttfamily EXPECT\+\_\+$\ast$()/\+ASSERT\+\_\+$\ast$()} failures in your test code, see \href{\#catching-failures}{\texttt{ \char`\"{}\+Catching\char`\"{} Failures}}.\hypertarget{md_04_cmake_build_debug__deps_googletest_src_docs_advanced_autotoc_md40}{}\doxysubsection{How to Write a Death Test}\label{md_04_cmake_build_debug__deps_googletest_src_docs_advanced_autotoc_md40}
...
In particular, if {\ttfamily statement} generates an {\ttfamily ASSERT\+\_\+$\ast$} or {\ttfamily EXPECT\+\_\+$\ast$} failure, it will {\bfseries{not}} cause the death test to fail, as googletest assertions don\textquotesingle{}t abort the process.\hypertarget{md_04_cmake_build_debug__deps_googletest_src_docs_advanced_autotoc_md41}{}\doxysubsection{Death Test Naming}\label{md_04_cmake_build_debug__deps_googletest_src_docs_advanced_autotoc_md41}
...
\end{DoxyCode}
\hypertarget{md_04_cmake_build_debug__deps_googletest_src_docs_advanced_autotoc_md42}{}\doxysubsection{Regular Expression Syntax}\label{md_04_cmake_build_debug__deps_googletest_src_docs_advanced_autotoc_md42}
...
To help you determine which capability is available on your system, googletest defines macros to govern which regular expression it is using. The macros are\+: {\ttfamily GTEST\+\_\+\+USES\+\_\+\+SIMPLE\+\_\+\+RE=1} or {\ttfamily GTEST\+\_\+\+USES\+\_\+\+POSIX\+\_\+\+RE=1}. If you want your death tests to work in all cases, you can either {\ttfamily \#if} on these macros or use the more limited syntax only.\hypertarget{md_04_cmake_build_debug__deps_googletest_src_docs_advanced_autotoc_md43}{}\doxysubsection{How It Works}\label{md_04_cmake_build_debug__deps_googletest_src_docs_advanced_autotoc_md43}
See \href{reference/assertions.md\#death}{\texttt{ Death Assertions}} in the Assertions Reference.\hypertarget{md_04_cmake_build_debug__deps_googletest_src_docs_advanced_autotoc_md44}{}\doxysubsection{Death Tests And Threads}\label{md_04_cmake_build_debug__deps_googletest_src_docs_advanced_autotoc_md44}
...
It\textquotesingle{}s perfectly fine to create threads inside a death test statement; they are executed in a separate process and cannot affect the parent.\hypertarget{md_04_cmake_build_debug__deps_googletest_src_docs_advanced_autotoc_md45}{}\doxysubsection{Death Test Styles}\label{md_04_cmake_build_debug__deps_googletest_src_docs_advanced_autotoc_md45}
...
\end{DoxyCode}
\hypertarget{md_04_cmake_build_debug__deps_googletest_src_docs_advanced_autotoc_md46}{}\doxysubsection{Caveats}\label{md_04_cmake_build_debug__deps_googletest_src_docs_advanced_autotoc_md46}
...
Despite the improved thread safety afforded by the \char`\"{}threadsafe\char`\"{} style of death test, thread problems such as deadlock are still possible in the presence of handlers registered with {\ttfamily pthread\+\_\+atfork(3)}.\hypertarget{md_04_cmake_build_debug__deps_googletest_src_docs_advanced_autotoc_md47}{}\doxysection{Using Assertions in Sub-\/routines}\label{md_04_cmake_build_debug__deps_googletest_src_docs_advanced_autotoc_md47}
\{\+: .callout .note\} Note\+: If you want to put a series of test assertions in a subroutine to check for a complex condition, consider using \href{gmock_cook_book.md\#NewMatchers}{\texttt{ a custom GMock matcher}} instead. This lets you provide a more readable error message in case of failure and avoid all of the issues described below.\hypertarget{md_04_cmake_build_debug__deps_googletest_src_docs_advanced_autotoc_md48}{}\doxysubsection{Adding Traces to Assertions}\label{md_04_cmake_build_debug__deps_googletest_src_docs_advanced_autotoc_md48}
...
\end{DoxyEnumerate}\hypertarget{md_04_cmake_build_debug__deps_googletest_src_docs_advanced_autotoc_md49}{}\doxysubsection{Propagating Fatal Failures}\label{md_04_cmake_build_debug__deps_googletest_src_docs_advanced_autotoc_md49}
...
To alleviate this, googletest provides three different solutions. You could use either exceptions, the {\ttfamily (ASSERT$\vert$\+EXPECT)\+\_\+\+NO\+\_\+\+FATAL\+\_\+\+FAILURE} assertions or the {\ttfamily Has\+Fatal\+Failure()} function. They are described in the following two subsections.\hypertarget{md_04_cmake_build_debug__deps_googletest_src_docs_advanced_autotoc_md50}{}\doxysubsubsection{Asserting on Subroutines with an exception}\label{md_04_cmake_build_debug__deps_googletest_src_docs_advanced_autotoc_md50}
...
This listener should be added after other listeners if you have any, otherwise they won\textquotesingle{}t see failed {\ttfamily On\+Test\+Part\+Result}.\hypertarget{md_04_cmake_build_debug__deps_googletest_src_docs_advanced_autotoc_md51}{}\doxysubsubsection{Asserting on Subroutines}\label{md_04_cmake_build_debug__deps_googletest_src_docs_advanced_autotoc_md51}
...
Assertions from multiple threads are currently not supported on Windows.\hypertarget{md_04_cmake_build_debug__deps_googletest_src_docs_advanced_autotoc_md52}{}\doxysubsubsection{Checking for Failures in the Current Test}\label{md_04_cmake_build_debug__deps_googletest_src_docs_advanced_autotoc_md52}
...
Similarly, {\ttfamily Has\+Nonfatal\+Failure()} returns {\ttfamily true} if the current test has at least one non-\/fatal failure, and {\ttfamily Has\+Failure()} returns {\ttfamily true} if the current test has at least one failure of either kind.\hypertarget{md_04_cmake_build_debug__deps_googletest_src_docs_advanced_autotoc_md53}{}\doxysection{Logging Additional Information}\label{md_04_cmake_build_debug__deps_googletest_src_docs_advanced_autotoc_md53}
...
\hypertarget{md_04_cmake_build_debug__deps_googletest_src_docs_advanced_autotoc_md54}{}\doxysection{Sharing Resources Between Tests in the Same Test Suite}\label{md_04_cmake_build_debug__deps_googletest_src_docs_advanced_autotoc_md54}
...
\{\+: .callout .note\} NOTE\+: Though the above code declares {\ttfamily Set\+Up\+Test\+Suite()} protected, it may sometimes be necessary to declare it public, such as when using it with {\ttfamily TEST\+\_\+P}.\hypertarget{md_04_cmake_build_debug__deps_googletest_src_docs_advanced_autotoc_md55}{}\doxysection{Global Set-\/\+Up and Tear-\/\+Down}\label{md_04_cmake_build_debug__deps_googletest_src_docs_advanced_autotoc_md55}
...
\end{DoxyItemize}\hypertarget{md_04_cmake_build_debug__deps_googletest_src_docs_advanced_autotoc_md57}{}\doxysubsection{How to Write Value-\/\+Parameterized Tests}\label{md_04_cmake_build_debug__deps_googletest_src_docs_advanced_autotoc_md57}
...
You can see \href{https://github.com/google/googletest/blob/main/googletest/samples/sample7_unittest.cc}{\texttt{ sample7\+\_\+unittest.\+cc}} and \href{https://github.com/google/googletest/blob/main/googletest/samples/sample8_unittest.cc}{\texttt{ sample8\+\_\+unittest.\+cc}} for more examples.\hypertarget{md_04_cmake_build_debug__deps_googletest_src_docs_advanced_autotoc_md58}{}\doxysubsection{Creating Value-\/\+Parameterized Abstract Tests}\label{md_04_cmake_build_debug__deps_googletest_src_docs_advanced_autotoc_md58}
...
Once they are defined, you can instantiate them by including {\ttfamily foo\+\_\+param\+\_\+test.\+h}, invoking {\ttfamily INSTANTIATE\+\_\+\+TEST\+\_\+\+SUITE\+\_\+\+P()}, and depending on the library target that contains {\ttfamily foo\+\_\+param\+\_\+test.\+cc}. You can instantiate the same abstract test suite multiple times, possibly in different source files.\hypertarget{md_04_cmake_build_debug__deps_googletest_src_docs_advanced_autotoc_md59}{}\doxysubsection{Specifying Names for Value-\/\+Parameterized Test Parameters}\label{md_04_cmake_build_debug__deps_googletest_src_docs_advanced_autotoc_md59}
...
\end{DoxyCode}
\hypertarget{md_04_cmake_build_debug__deps_googletest_src_docs_advanced_autotoc_md60}{}\doxysection{Typed Tests}\label{md_04_cmake_build_debug__deps_googletest_src_docs_advanced_autotoc_md60}
...
You can see \href{https://github.com/google/googletest/blob/main/googletest/samples/sample6_unittest.cc}{\texttt{ sample6\+\_\+unittest.\+cc}} for a complete example.\hypertarget{md_04_cmake_build_debug__deps_googletest_src_docs_advanced_autotoc_md61}{}\doxysection{Type-\/\+Parameterized Tests}\label{md_04_cmake_build_debug__deps_googletest_src_docs_advanced_autotoc_md61}
...
You can see \href{https://github.com/google/googletest/blob/main/googletest/samples/sample6_unittest.cc}{\texttt{ sample6\+\_\+unittest.\+cc}} for a complete example.\hypertarget{md_04_cmake_build_debug__deps_googletest_src_docs_advanced_autotoc_md62}{}\doxysection{Testing Private Code}\label{md_04_cmake_build_debug__deps_googletest_src_docs_advanced_autotoc_md62}
...
\} // namespace my\+\_\+namespace \`{}\`{}\`{}
\end{DoxyItemize}\hypertarget{md_04_cmake_build_debug__deps_googletest_src_docs_advanced_autotoc_md63}{}\doxysection{\char`\"{}\+Catching\char`\"{} Failures}\label{md_04_cmake_build_debug__deps_googletest_src_docs_advanced_autotoc_md63}
...
\end{DoxyEnumerate}\hypertarget{md_04_cmake_build_debug__deps_googletest_src_docs_advanced_autotoc_md64}{}\doxysection{Registering tests programmatically}\label{md_04_cmake_build_debug__deps_googletest_src_docs_advanced_autotoc_md64}
...
\end{DoxyCode}
\hypertarget{md_04_cmake_build_debug__deps_googletest_src_docs_advanced_autotoc_md65}{}\doxysection{Getting the Current Test\textquotesingle{}s Name}\label{md_04_cmake_build_debug__deps_googletest_src_docs_advanced_autotoc_md65}
...
{\ttfamily current\+\_\+test\+\_\+info()} returns a null pointer if no test is running. In particular, you cannot find the test suite name in {\ttfamily Set\+Up\+Test\+Suite()}, {\ttfamily Tear\+Down\+Test\+Suite()} (where you know the test suite name implicitly), or functions called from them.\hypertarget{md_04_cmake_build_debug__deps_googletest_src_docs_advanced_autotoc_md66}{}\doxysection{Extending googletest by Handling Test Events}\label{md_04_cmake_build_debug__deps_googletest_src_docs_advanced_autotoc_md66}
googletest provides an {\bfseries{event listener API}} to let you receive notifications about the progress of a test program and test failures. The events you can listen to include the start and end of the test program, a test suite, or a test method, among others. You may use this API to augment or replace the standard console output, replace the XML output, or provide a completely different form of output, such as a GUI or a database. You can also use test events as checkpoints to implement a resource leak checker, for example.\hypertarget{md_04_cmake_build_debug__deps_googletest_src_docs_advanced_autotoc_md67}{}\doxysubsection{Defining Event Listeners}\label{md_04_cmake_build_debug__deps_googletest_src_docs_advanced_autotoc_md67}
...
\end{DoxyCode}
\hypertarget{md_04_cmake_build_debug__deps_googletest_src_docs_advanced_autotoc_md68}{}\doxysubsection{Using Event Listeners}\label{md_04_cmake_build_debug__deps_googletest_src_docs_advanced_autotoc_md68}
...
You may append more than one listener to the list. When an {\ttfamily On$\ast$\+Start()} or {\ttfamily On\+Test\+Part\+Result()} event is fired, the listeners will receive it in the order they appear in the list (since new listeners are added to the end of the list, the default text printer and the default XML generator will receive the event first). An {\ttfamily On$\ast$\+End()} event will be received by the listeners in the {\itshape reverse} order. This allows output by listeners added later to be framed by output from listeners added earlier.\hypertarget{md_04_cmake_build_debug__deps_googletest_src_docs_advanced_autotoc_md69}{}\doxysubsection{Generating Failures in Listeners}\label{md_04_cmake_build_debug__deps_googletest_src_docs_advanced_autotoc_md69}
...
See \href{https://github.com/google/googletest/blob/main/googletest/samples/sample10_unittest.cc}{\texttt{ sample10\+\_\+unittest.\+cc}} for an example of a failure-\/raising listener.\hypertarget{md_04_cmake_build_debug__deps_googletest_src_docs_advanced_autotoc_md70}{}\doxysection{Running Test Programs\+: Advanced Options}\label{md_04_cmake_build_debug__deps_googletest_src_docs_advanced_autotoc_md70}
...
If an option is specified both by an environment variable and by a flag, the latter takes precedence.\hypertarget{md_04_cmake_build_debug__deps_googletest_src_docs_advanced_autotoc_md71}{}\doxysubsection{Selecting Tests}\label{md_04_cmake_build_debug__deps_googletest_src_docs_advanced_autotoc_md71}
\hypertarget{md_04_cmake_build_debug__deps_googletest_src_docs_advanced_autotoc_md72}{}\doxysubsubsection{Listing Test Names}\label{md_04_cmake_build_debug__deps_googletest_src_docs_advanced_autotoc_md72}
...
None of the tests listed are actually run if the flag is provided. There is no corresponding environment variable for this flag.\hypertarget{md_04_cmake_build_debug__deps_googletest_src_docs_advanced_autotoc_md73}{}\doxysubsubsection{Running a Subset of the Tests}\label{md_04_cmake_build_debug__deps_googletest_src_docs_advanced_autotoc_md73}
...
{\itshape }\hypertarget{md_04_cmake_build_debug__deps_googletest_src_docs_advanced_autotoc_md74}{}\doxysubsubsection{Stop test execution upon first failure}\label{md_04_cmake_build_debug__deps_googletest_src_docs_advanced_autotoc_md74}
...
{\itshape }\hypertarget{md_04_cmake_build_debug__deps_googletest_src_docs_advanced_autotoc_md75}{}\doxysubsubsection{Temporarily Disabling Tests}\label{md_04_cmake_build_debug__deps_googletest_src_docs_advanced_autotoc_md75}
...
{\itshape }\hypertarget{md_04_cmake_build_debug__deps_googletest_src_docs_advanced_autotoc_md76}{}\doxysubsubsection{Temporarily Enabling Disabled Tests}\label{md_04_cmake_build_debug__deps_googletest_src_docs_advanced_autotoc_md76}
...
{\itshape }\hypertarget{md_04_cmake_build_debug__deps_googletest_src_docs_advanced_autotoc_md77}{}\doxysubsection{Repeating the Tests}\label{md_04_cmake_build_debug__deps_googletest_src_docs_advanced_autotoc_md77}
...
{\itshape }\hypertarget{md_04_cmake_build_debug__deps_googletest_src_docs_advanced_autotoc_md78}{}\doxysubsection{Shuffling the Tests}\label{md_04_cmake_build_debug__deps_googletest_src_docs_advanced_autotoc_md78}
...
{\itshape }\hypertarget{md_04_cmake_build_debug__deps_googletest_src_docs_advanced_autotoc_md79}{}\doxysubsection{Distributing Test Functions to Multiple Machines}\label{md_04_cmake_build_debug__deps_googletest_src_docs_advanced_autotoc_md79}
...
{\itshape }\hypertarget{md_04_cmake_build_debug__deps_googletest_src_docs_advanced_autotoc_md80}{}\doxysubsection{Controlling Test Output}\label{md_04_cmake_build_debug__deps_googletest_src_docs_advanced_autotoc_md80}
{\itshape  }\hypertarget{md_04_cmake_build_debug__deps_googletest_src_docs_advanced_autotoc_md81}{}\doxysubsubsection{Colored Terminal Output}\label{md_04_cmake_build_debug__deps_googletest_src_docs_advanced_autotoc_md81}
...
{\itshape }\hypertarget{md_04_cmake_build_debug__deps_googletest_src_docs_advanced_autotoc_md82}{}\doxysubsubsection{Suppressing test passes}\label{md_04_cmake_build_debug__deps_googletest_src_docs_advanced_autotoc_md82}
...
{\itshape }\hypertarget{md_04_cmake_build_debug__deps_googletest_src_docs_advanced_autotoc_md83}{}\doxysubsubsection{Suppressing the Elapsed Time}\label{md_04_cmake_build_debug__deps_googletest_src_docs_advanced_autotoc_md83}
...
{\itshape }\hypertarget{md_04_cmake_build_debug__deps_googletest_src_docs_advanced_autotoc_md84}{}\doxysubsubsection{Suppressing UTF-\/8 Text Output}\label{md_04_cmake_build_debug__deps_googletest_src_docs_advanced_autotoc_md84}
...
{\itshape }\hypertarget{md_04_cmake_build_debug__deps_googletest_src_docs_advanced_autotoc_md85}{}\doxysubsubsection{Generating an XML Report}\label{md_04_cmake_build_debug__deps_googletest_src_docs_advanced_autotoc_md85}
...
{\itshape }\hypertarget{md_04_cmake_build_debug__deps_googletest_src_docs_advanced_autotoc_md86}{}\doxysubsubsection{Generating a JSON Report}\label{md_04_cmake_build_debug__deps_googletest_src_docs_advanced_autotoc_md86}
...
{\itshape }\hypertarget{md_04_cmake_build_debug__deps_googletest_src_docs_advanced_autotoc_md87}{}\doxysubsection{Controlling How Failures Are Reported}\label{md_04_cmake_build_debug__deps_googletest_src_docs_advanced_autotoc_md87}
{\itshape  }\hypertarget{md_04_cmake_build_debug__deps_googletest_src_docs_advanced_autotoc_md88}{}\doxysubsubsection{Detecting Test Premature Exit}\label{md_04_cmake_build_debug__deps_googletest_src_docs_advanced_autotoc_md88}
...
{\itshape }\hypertarget{md_04_cmake_build_debug__deps_googletest_src_docs_advanced_autotoc_md89}{}\doxysubsubsection{Turning Assertion Failures into Break-\/\+Points}\label{md_04_cmake_build_debug__deps_googletest_src_docs_advanced_autotoc_md89}
...
{\itshape }\hypertarget{md_04_cmake_build_debug__deps_googletest_src_docs_advanced_autotoc_md90}{}\doxysubsubsection{Disabling Catching Test-\/\+Thrown Exceptions}\label{md_04_cmake_build_debug__deps_googletest_src_docs_advanced_autotoc_md90}
...
{\itshape }\hypertarget{md_04_cmake_build_debug__deps_googletest_src_docs_advanced_autotoc_md91}{}\doxysubsection{Sanitizer Integration}\label{md_04_cmake_build_debug__deps_googletest_src_docs_advanced_autotoc_md91}
