\hypertarget{md_04_cmake_build_debug__deps_googletest_src_docs_primer_autotoc_md236}{}\doxysection{Introduction\+: Why googletest?}\label{md_04_cmake_build_debug__deps_googletest_src_docs_primer_autotoc_md236}
...
\end{longtabu}
\hypertarget{md_04_cmake_build_debug__deps_googletest_src_docs_primer_autotoc_md238}{}\doxysection{Basic Concepts}\label{md_04_cmake_build_debug__deps_googletest_src_docs_primer_autotoc_md238}
...
We\textquotesingle{}ll now explain how to write a test program, starting at the individual assertion level and building up to tests and test suites.\hypertarget{md_04_cmake_build_debug__deps_googletest_src_docs_primer_autotoc_md239}{}\doxysection{Assertions}\label{md_04_cmake_build_debug__deps_googletest_src_docs_primer_autotoc_md239}
...
Google\+Test provides a collection of assertions for verifying the behavior of your code in various ways. You can check Boolean conditions, compare values based on relational operators, verify string values, floating-\/point values, and much more. There are even assertions that enable you to verify more complex states by providing custom predicates. For the complete list of assertions provided by Google\+Test, see the \mbox{\hyperlink{md_04_cmake_build_debug__deps_googletest_src_docs_reference_assertions}{Assertions Reference}}.\hypertarget{md_04_cmake_build_debug__deps_googletest_src_docs_primer_autotoc_md240}{}\doxysection{Simple Tests}\label{md_04_cmake_build_debug__deps_googletest_src_docs_primer_autotoc_md240}
To create a test\+:
...
{\bfseries{Availability}}\+: Linux, Windows, Mac.\hypertarget{md_04_cmake_build_debug__deps_googletest_src_docs_primer_same-data-multiple-tests}{}\doxysection{Test Fixtures\+: Using the Same Data Configuration for Multiple Tests}\label{md_04_cmake_build_debug__deps_googletest_src_docs_primer_same-data-multiple-tests}
...
{\bfseries{Availability}}\+: Linux, Windows, Mac.\hypertarget{md_04_cmake_build_debug__deps_googletest_src_docs_primer_autotoc_md241}{}\doxysection{Invoking the Tests}\label{md_04_cmake_build_debug__deps_googletest_src_docs_primer_autotoc_md241}
...
{\bfseries{Availability}}\+: Linux, Windows, Mac.\hypertarget{md_04_cmake_build_debug__deps_googletest_src_docs_primer_autotoc_md242}{}\doxysection{Writing the main() Function}\label{md_04_cmake_build_debug__deps_googletest_src_docs_primer_autotoc_md242}
...
\{\+: .callout .note\} NOTE\+: {\ttfamily Parse\+GUnit\+Flags()} is deprecated in favor of {\ttfamily Init\+Google\+Test()}.\hypertarget{md_04_cmake_build_debug__deps_googletest_src_docs_primer_autotoc_md243}{}\doxysection{Known Limitations}\label{md_04_cmake_build_debug__deps_googletest_src_docs_primer_autotoc_md243}
