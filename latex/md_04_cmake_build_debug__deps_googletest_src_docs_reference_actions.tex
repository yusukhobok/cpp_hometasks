...
\end{longtabu}
\hypertarget{md_04_cmake_build_debug__deps_googletest_src_docs_reference_actions_autotoc_md256}{}\doxysection{Side Effects}\label{md_04_cmake_build_debug__deps_googletest_src_docs_reference_actions_autotoc_md256}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
\cellcolor{\tableheadbgcolor}\textbf{ Action   }&\cellcolor{\tableheadbgcolor}\textbf{ Description    }\\\cline{1-2}
...
\end{longtabu}
\hypertarget{md_04_cmake_build_debug__deps_googletest_src_docs_reference_actions_autotoc_md257}{}\doxysection{Using a Function, Functor, or Lambda as an Action}\label{md_04_cmake_build_debug__deps_googletest_src_docs_reference_actions_autotoc_md257}
...
calls the mock function\textquotesingle{}s \#2 argument, passing to it {\ttfamily 5} and {\ttfamily string(\char`\"{}\+Hi\char`\"{})} by value, and {\ttfamily foo} by reference.\hypertarget{md_04_cmake_build_debug__deps_googletest_src_docs_reference_actions_autotoc_md258}{}\doxysection{Default Action}\label{md_04_cmake_build_debug__deps_googletest_src_docs_reference_actions_autotoc_md258}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
\cellcolor{\tableheadbgcolor}\textbf{ Action   }&\cellcolor{\tableheadbgcolor}\textbf{ Description    }\\\cline{1-2}
...
\{\+: .callout .note\} {\bfseries{Note\+:}} due to technical reasons, {\ttfamily Do\+Default()} cannot be used inside a composite action -\/ trying to do so will result in a run-\/time error.\hypertarget{md_04_cmake_build_debug__deps_googletest_src_docs_reference_actions_autotoc_md259}{}\doxysection{Composite Actions}\label{md_04_cmake_build_debug__deps_googletest_src_docs_reference_actions_autotoc_md259}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
\cellcolor{\tableheadbgcolor}\textbf{ Action   }&\cellcolor{\tableheadbgcolor}\textbf{ Description    }\\\cline{1-2}
...
\end{longtabu}
\hypertarget{md_04_cmake_build_debug__deps_googletest_src_docs_reference_actions_autotoc_md260}{}\doxysection{Defining Actions}\label{md_04_cmake_build_debug__deps_googletest_src_docs_reference_actions_autotoc_md260}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
